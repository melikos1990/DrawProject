...
{
    public class CaseAssignmentCallCenterData : ICaseAssignmentCallCenterIntegrationData
    {
        private readonly ICaseAggregate _CaseAggregate;
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;

        public CaseAssignmentCallCenterData(ICaseAggregate CaseAggregate, IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
