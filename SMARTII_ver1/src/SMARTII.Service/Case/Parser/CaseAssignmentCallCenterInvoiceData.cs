...
{
    public class CaseAssignmentCallCenterInvoiceData : ICaseAssignmentCallCenterIntegrationData
    {
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;
        public CaseAssignmentCallCenterInvoiceData(IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
        ...
        public List<ExcelCaseAssignmentList> DataToDomainModel(List<SP_GetCaseAssignmentList> data, CaseAssignmentCallCenterCondition condition)
        {
            ...
            foreach (var item in data)
            {
                ...
                {
                    CaseAssignmentProcessType = CaseAssignmentProcessType.Invoice,
                    ...
                    ModeType = CaseAssignmentProcessType.Invoice.GetDescription(),
                    AssignmentType = ((CaseAssignmentComplaintInvoiceType)item.Type).GetDescription(),
