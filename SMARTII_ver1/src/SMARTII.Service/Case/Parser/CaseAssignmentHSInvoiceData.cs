...
{
    public class CaseAssignmentHSInvoiceData : ICaseAssignmentHSIntegrationData
    {
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;

        public CaseAssignmentHSInvoiceData(IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
