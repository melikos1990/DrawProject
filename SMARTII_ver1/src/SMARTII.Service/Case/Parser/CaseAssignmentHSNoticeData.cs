...
{
    public class CaseAssignmentHSNoticeData : ICaseAssignmentHSIntegrationData
    {
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;

        public CaseAssignmentHSNoticeData(IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
