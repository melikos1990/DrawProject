...
{
    public class CaseAssignmentHSCommuncateData : ICaseAssignmentHSIntegrationData
    {
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;

        public CaseAssignmentHSCommuncateData(IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
