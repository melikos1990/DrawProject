...
{
    public class CaseAssignmentCallCenterNoticeData : ICaseAssignmentCallCenterIntegrationData
    {
        private readonly IMasterAggregate _MasterAggregate;
        private readonly IIndex<string, IExcelParser> _ExcelParser;

        public CaseAssignmentCallCenterNoticeData(IMasterAggregate MasterAggregate, IIndex<string, IExcelParser> ExcelParser)
        {
        ...
        public List<ExcelCaseAssignmentList> DataToDomainModel(List<SP_GetCaseAssignmentList> data, CaseAssignmentCallCenterCondition condition)
        {
            ...
            foreach (var item in data)
            {
                ...
                {
                    CaseAssignmentProcessType = CaseAssignmentProcessType.Notice,
                    ...
                    ModeType = CaseAssignmentProcessType.Notice.GetDescription(),
                    AssignmentType = CaseAssignmentComplaintNoticeType.Noticed.GetDescription(),
