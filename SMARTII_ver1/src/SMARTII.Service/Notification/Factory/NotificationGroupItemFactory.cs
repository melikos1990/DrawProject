...
{
    public class NotificationGroupItemFactory : NotificationGroupBaseFactory, INotificationGroupFactory
    {
        ...
        public NotificationGroupItemFactory(ICommonAggregate CommonAggregate,
        ...
        {
            _CommonAggregate.Logger.Info($"【提醒群組通知】 《商品行為》");
