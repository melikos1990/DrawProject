...
{
    public class MisterDonutFactory : IMisterDonutFactory, IImportStoreFactory
    {
        private readonly MisterDonutFacade _MisterDonutFacade;
        ...
        public MisterDonutFactory(MisterDonutFacade MisterDonutFacade, ReportProvider ReportProvider, ReportFacade ReportFacade, IOrganizationAggregate OrganizationAggregate, ReportFactory ReportFactory, ICommonAggregate CommonAggregate)
        {
            _MisterDonutFacade = MisterDonutFacade;
        ...
        {
            //Facade 找資料SP
            var list = await _MisterDonutFacade.GetOnCallExcel(start, end, EssentialCache.BusinessKeyValue.MisterDonut);
            //匯出excel
