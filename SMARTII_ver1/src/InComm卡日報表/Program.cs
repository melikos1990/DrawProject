...
namespace InComm卡日報表
{
    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            // 取得附件密碼
            DataStorage.ZipPassWord.TryGetValue(BusinessKeyValue.ICC, out var password);
            service.SendICCOnCallExcel(startDateTime, endDateTime, password);
