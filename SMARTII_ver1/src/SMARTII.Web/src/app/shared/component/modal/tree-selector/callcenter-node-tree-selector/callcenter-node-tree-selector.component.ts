...
import { OrganizationDataRangeSearchViewModel, CallCenterNodeViewModel } from 'src/app/model/organization.model';
import { BaseComponent } from 'src/app/pages/base/base.component';
import { HttpService } from 'src/app/shared/service/http.service';

@Component({
  selector: 'app-callcenter-node-tree-selector',
  templateUrl: './callcenter-node-tree-selector.component.html',
})
export class CallcenterNodeTreeSelectorComponent extends BaseComponent implements OnInit {
