import { Component, OnInit, Input, Injector, forwardRef, EventEmitter, Output } from '@angular/core';
...
export class CCSelectComponent extends BaseComponent implements OnInit {
  @Input() id: string = '';
  ...
  ngOnInit() {
    this.http.post(`Common/Organization/GetCallCenterRootNodes`,
      {
        isSelf: this.isSelf
      }
      , {}).subscribe((resp: any) => {
