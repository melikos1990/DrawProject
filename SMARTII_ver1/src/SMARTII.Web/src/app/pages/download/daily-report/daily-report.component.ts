...
import { tryGetReportKey } from 'src/global';
...
export const PREFIX = 'DailyReportComponent';
...
export class DailyReportComponent extends FormBaseComponent implements OnInit {
 ...
 */
  ...
  btnDownload() {
    ...
    let params = { DateRange: this.model.DateTimeRange };
    ...
    this.store.dispatch(new DownloadActions.downloadReport(payload));
  }
