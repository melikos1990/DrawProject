...
const PREFIX = "HeaderQurterNodeBUCaseSearchComponent";

@Component({
  selector: 'app-headerqurter-bu-case-search',
  templateUrl: './headerqurter-bu-case-search.component.html',
  styleUrls: ['./headerqurter-bu-case-search.component.scss']
})
export class HeaderQurterBUCaseSearchComponent extends SearchBaseComponent implements OnInit {
