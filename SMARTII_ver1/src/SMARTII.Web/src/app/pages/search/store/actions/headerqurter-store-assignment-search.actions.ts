...
export const CASE_HS_REPORT = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_REPORT';
export const CASE_HS_REPORT_SUCCESS = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_REPORT_SUCCESS';
export const CASE_HS_REPORT_FAILED = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_REPORT_FAILED';
export const CASE_HS_GETLIST = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_GETLIST';
export const CASE_HS_GETLIST_SUCCESS = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_GETLIST_SUCCESS';
export const CASE_HS_GETLIST_FAILED = '[CASE_ASSIGNMENT_SEARCH] CASE_HS_GETLIST_FAILED';

export class headerqurterStoreReport implements Action {
  public type: string = CASE_HS_REPORT;
  constructor(public payload: CaseAssignmentHeaderqurterStoreSearchViewModel) { }
}
...
export class headerqurterStoreGetList implements Action {
  ...
  constructor(public payload: EntrancePayload<CaseAssignmentHeaderqurterStoreSearchViewModel>) { }
}
