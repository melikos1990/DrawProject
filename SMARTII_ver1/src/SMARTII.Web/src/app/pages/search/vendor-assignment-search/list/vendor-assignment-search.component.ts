...
import { CaseAssignmentModeType, CaseAssignmentVendorSearchViewModel } from 'src/app/model/search.model';
...
import * as VendorCaseAssignmentSearchActions from '../../store/actions/vendor-assignment-search.actions';
...
const PREFIX = "VendorAssignmentSearchComponent";

@Component({
  selector: 'app-vendor-assignment-search',
  templateUrl: './vendor-assignment-search.component.html',
  styleUrls: ['./vendor-assignment-search.component.scss']
})
export class VendorAssignmentSearchComponent extends SearchBaseComponent implements OnInit {
  ...
  model: CaseAssignmentVendorSearchViewModel = {} as CaseAssignmentVendorSearchViewModel;
  ...
  subscription() {
    this.store.select(x => x.mySearch.vendorCaseAssignmentSearch.caseAssignmentList)
  ...
  btnReport($event: any) {
    this.fillback();
    this.store.dispatch(new VendorCaseAssignmentSearchActions.vendorReport(this.model));
  }
  btnRender($event: any) {
    ...
    this.store.dispatch(new VendorCaseAssignmentSearchActions.vendorGetList(payload));
  }
