...
const PREFIX = "HeaderqurterStoreAssignmentSearchComponent";

@Component({
  selector: 'app-headerqurter-store-assignment-search',
  templateUrl: './headerqurter-store-assignment-search.component.html',
  styleUrls: ['./headerqurter-store-assignment-search.component.scss']
})
export class HeaderqurterStoreAssignmentSearchComponent extends SearchBaseComponent implements OnInit {
