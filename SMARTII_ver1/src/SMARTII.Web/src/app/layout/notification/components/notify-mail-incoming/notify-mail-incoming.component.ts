...
@Component({
  selector: 'app-notify-mail-incoming',
  templateUrl: './notify-mail-incoming.component.html',
  styleUrls: ['./notify-mail-incoming.component.scss']
})
export class NotifyMailIncomingComponent extends BaseComponent implements OnInit {
  ...
  direct(){
    ...
    this.store.dispatch(new fromRootActions.RouteActions.changeRouteAction({
      url: './pages/case/official-email-adopt',
      params: {
