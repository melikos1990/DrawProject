...
{
    public class ASOFactory : IASOFactory, IImportStoreFactory
    {
        private readonly ASOFacade _ASOFacade;
        ...
        public ASOFactory(ASOFacade ASOFacade, ReportFacade ReportFacade, IOrganizationAggregate OrganizationAggregate, ReportProvider ReportProvider, ReportFactory ReportFactory, ICommonAggregate CommonAggregate)
        {
            _ASOFacade = ASOFacade;
        ...
        {
            //Facade 找資料SP
            var list = await _ASOFacade.GenerateOnCallExcel(start, end, EssentialCache.BusinessKeyValue.ASO);
            //匯出excel
        ...
        /// <param name="end"></param>
        /// <returns></returns>
        public async Task<byte[]> GenerateAssignmentOnCallExcel(DateTime start, DateTime end)
        {
            //Facade 找資料SP
            var list = await _ASOFacade.GenerateAssignmentOnCallExcel(start, end, EssentialCache.BusinessKeyValue.ASO);
            //匯出excel
            var result = _ReportProvider.GetAssignmentOnCallExcel(list, end);
            return result;
        ...
        /// <param name="end"></param>
        /// <returns></returns>
        public async Task<byte[]> GenerateEveryDayExcel(DateTime start, DateTime end)
        {
            //Facade 找資料SP
            var list = await _ASOFacade.GenerateEveryDayExcel(start, end, EssentialCache.BusinessKeyValue.ASO);
            //匯出excel
            var result = _ReportProvider.GetEveryDayExcel(list, start, end);
            return result;
        }
