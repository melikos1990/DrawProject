...
{
    public class FORTUNEFactory : IFORTUNEFactory, IImportStoreFactory
    {
        private readonly FORTUNEFacade _FORTUNEFacade;
        ...
        public FORTUNEFactory(FORTUNEFacade FORTUNEFacade, ReportFacade ReportFacade, IOrganizationAggregate OrganizationAggregate, ReportFactory ReportFactory, ICommonAggregate CommonAggregate)
        {
            _FORTUNEFacade = FORTUNEFacade;
        ...
        Task<byte[]> IFORTUNEFactory.GenerateOnCallExcel(DateTime start, DateTime end)
        {
            throw new NotImplementedException();
        }

        Task<byte[]> IFORTUNEFactory.GenerateAssignmentOnCallExcel(DateTime start, DateTime end)
        {
            throw new NotImplementedException();
        }

        Task<byte[]> IFORTUNEFactory.GenerateEveryDayExcel(DateTime start, DateTime end)
        {
            throw new NotImplementedException();
        }
    }
