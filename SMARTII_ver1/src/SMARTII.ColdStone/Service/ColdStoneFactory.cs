...
{
    public class ColdStoneFactory : IColdStoneFactory, IImportStoreFactory

    {
        private readonly ColdStoneFacade _ColdStoneFacade;
        ...
        public ColdStoneFactory(ColdStoneFacade ColdStoneFacade, ReportProvider ReportProvider, ReportFactory ReportFactory, ReportFacade ReportFacade, ICommonAggregate CommonAggregate, IOrganizationAggregate OrganizationAggregate)
        {
            _ColdStoneFacade = ColdStoneFacade;
        ...
        {
            //Facade 找資料SP
            var list = await _ColdStoneFacade.GetOnCallExcel(start, end, EssentialCache.BusinessKeyValue.ColdStone);
            //匯出excel
