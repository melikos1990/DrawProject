...
namespace OpenPoint日報表
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            // 取得附件密碼
            DataStorage.ZipPassWord.TryGetValue(BusinessKeyValue.OpenPoint, out var password);
            service.SendOpenPointOnCallExcel(startDateTime, endDateTime, password);
