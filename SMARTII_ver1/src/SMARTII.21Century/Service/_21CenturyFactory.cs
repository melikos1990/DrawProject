...
{
    public class _21CenturyFactory : I21Factory, IImportStoreFactory
    {

        private readonly _21CenturyFacade _21CenturyFacade;
        ...
        public _21CenturyFactory(_21CenturyFacade CenturyFacade, ReportProvider ReportProvider, ReportFacade ReportFacade, ReportFactory ReportFactory, IOrganizationAggregate OrganizationAggregate, ICommonAggregate CommonAggregate)
        {
            _21CenturyFacade = CenturyFacade;
        ...
        {
            //Facade 找資料SP
            var list = await _21CenturyFacade.GenerateOnCallExcel(start, end, EssentialCache.BusinessKeyValue._21Century);
            //匯出excel
