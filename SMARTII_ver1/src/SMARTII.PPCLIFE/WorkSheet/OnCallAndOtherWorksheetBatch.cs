...
{
    public class OnCallAndOtherWorksheetBatch : IWorksheet
    {
        public OnCallAndOtherWorksheetBatch()
        {
        }
        ...
        public void CreateWorksheet(XLWorkbook book, object payload, object extend = null)
        {
            ...
            //設定案件內容與結案內容固定欄寬
            ws.Column(column + 2).Width = 20;
            ws.Column(column + 3).Width = 20;
            ws.Column(column + 4).Width = 20;
