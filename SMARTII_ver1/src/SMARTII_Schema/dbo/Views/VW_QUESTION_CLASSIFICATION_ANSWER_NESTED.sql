...
CREATE VIEW [dbo].[VW_QUESTION_CLASSIFICATION_ANSWER_NESTED]   AS
...
SELECT 
    ISNULL(row_number() over(order by S.ID),0) as [INDEX],
	S.ID AS ANSWER_ID,
	S.TITLE,
	S.CONTENT,
...
FROM [dbo].QUESTION_CLASSIFICATION_ANSWER S JOIN 
