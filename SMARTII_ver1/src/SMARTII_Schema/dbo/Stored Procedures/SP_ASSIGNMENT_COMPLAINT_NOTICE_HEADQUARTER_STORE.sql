...
-- Description:	轉派案件查詢(總部、門市、廠商)歷程:通知單，依照以下條件先篩選一次
-- 連絡者、被反應者，一對多的資料在C# 二查後過濾
-- =============================================
CREATE PROCEDURE [dbo].[SP_ASSIGNMENT_COMPLAINT_NOTICE_HEADQUARTER_STORE]
...
-- Insert statements for procedure here
	...
	Inner Join CASE_ASSIGNMENT_COMPLAINT_NOTICE CACN on C.CASE_ID =CACN.CASE_ID
	'
