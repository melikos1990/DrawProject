...
{
    public class QuestionClassificationForExcel
    {

        public QuestionClassificationForExcel()
        {
        }
        public QuestionClassificationForExcel(Domain.Master.QuestionClassification domain)
        {
            this.ID = domain.ID;
