...
namespace SMARTII.Domain.Case
{
    public class CaseHSCondition
    {
        ...
        /// 反應單號
        /// </summary>
        [MSSQLFilter("y => Value !=null && y.ComplaintInvoice.Any(c=>c.InvoiceID.Contains(Value))"
        , PredicateType.And)]
        ...
        /// 標籤ID
        /// </summary>
        [MSSQLFilter("y => Value !=null &&  y.CaseTagList.Any(c=> Value.Contains(c.ID))"
        , PredicateType.And)]
        public List<int> CaseTagIDList { get; set; }
        /// <summary>
        /// 結案處置ID
        /// </summary>
        [MSSQLFilter(" y => Value !=null && y.CaseFinishReasonDatas.Any(c=> Value.Contains(c.ID))"
        , PredicateType.And)]
