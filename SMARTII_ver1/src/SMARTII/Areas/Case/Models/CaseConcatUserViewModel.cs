...
{
    public class CaseConcatUserViewModel : ConcatableUserViewModel
    {
        public CaseConcatUserViewModel() { }

        public CaseConcatUserViewModel(CaseConcatUser user)
        {
        ...
        public CaseConcatUser ToDomain()
        {
            var user = new CaseConcatUser();
