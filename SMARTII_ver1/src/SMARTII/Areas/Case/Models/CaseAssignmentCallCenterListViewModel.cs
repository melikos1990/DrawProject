...
{
    public class CaseAssignmentCallCenterListViewModel
    {

        public CaseAssignmentCallCenterListViewModel()
        {
        }
        public CaseAssignmentCallCenterListViewModel(ExcelCaseAssignmentList x)
        {
