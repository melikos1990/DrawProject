...
{
    public class CaseHSListViewModel
    {

        public CaseHSListViewModel()
        {
        }
        public CaseHSListViewModel(SP_GetCaseList sp_Data)
        {
            ...
            ComplainedUserName = complainedTarget.GetTableConcataAndComplained();
