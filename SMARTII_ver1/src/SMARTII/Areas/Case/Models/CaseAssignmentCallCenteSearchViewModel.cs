...
{
    public class CaseAssignmentCallCenteSearchViewModel
    {
        public CaseAssignmentCallCenteSearchViewModel()
        {
        }
        public CaseAssignmentCallCenterCondition ToDomain()
        {
            var result = new CaseAssignmentCallCenterCondition();
