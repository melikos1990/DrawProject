...
{
    public class CaseAssignmentHSListViewModel
    {
        public CaseAssignmentHSListViewModel()
        { }

        public CaseAssignmentHSListViewModel(ExcelCaseAssignmentList x)
        {
            ...
            ConcatUserName = x.ConcatUnitType == UnitType.Customer.GetDescription() ? x.ConcatCustomerName : x.ConcatUnitType == UnitType.Store.GetDescription() ? x.ConcatStore : x.ConcatOrganization;
