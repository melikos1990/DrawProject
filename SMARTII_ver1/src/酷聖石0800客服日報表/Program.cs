...
namespace 酷聖石0800客服日報表
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            // 取得附件密碼
            DataStorage.ZipPassWord.TryGetValue(BusinessKeyValue.ColdStone, out var password);
            service.SendColdStoneOnCallExcel(startDateTime, endDateTime, password);
