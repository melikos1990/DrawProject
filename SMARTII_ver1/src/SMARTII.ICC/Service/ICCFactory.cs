...
{
    public class ICCFactory : IICCFactory, IImportStoreFactory
    {
        private readonly ICCFacade _ICCFacade;
        ...
        public ICCFactory(ICCFacade ICCFacade, ReportProvider ReportProvider, ReportFactory ReportFactory, ICommonAggregate CommonAggregate, ReportFacade ReportFacade, IOrganizationAggregate OrganizationAggregate)
        {
            _ICCFacade = ICCFacade;
        ...
        {
            //Facade 找資料SP
            var list = await _ICCFacade.GenerateOnCallExcel(start, end, BusinessKeyValue.ICC);
            //匯出excel
