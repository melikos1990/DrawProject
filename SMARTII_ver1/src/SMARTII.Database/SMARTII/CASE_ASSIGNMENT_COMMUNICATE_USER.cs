...
namespace SMARTII.Database.SMARTII
{
    ...
    public partial class CASE_ASSIGNMENT_COMMUNICATE_USER
    {
        public int ID { get; set; }
        public int COMMUNICATE_ID { get; set; }
        ...
        public virtual CASE_ASSIGNMENT_COMMUNICATE CASE_ASSIGNMENT_COMMUNICATE { get; set; }
    }
}
